...
const styles = StyleSheet.create({
  ...
  queueCard: { borderRadius: 12, padding: 14, marginTop: 12, borderWidth: 1 },
  queueTitle: { fontSize: 15, fontWeight: '700' },
  queueSub: { fontSize: 13, marginTop: 4 },
  queueJoinBtn: { borderRadius: 10, padding: 12, alignItems: 'center', marginTop: 10 },
  queueJoinBtnText: { color: '#000', fontWeight: '700', fontSize: 14 },
  queueLeaveBtn: { borderRadius: 10, padding: 10, alignItems: 'center', marginTop: 10, borderWidth: 1 },
  queueLeaveBtnText: { color: '#f44336', fontWeight: '600', fontSize: 13 },
